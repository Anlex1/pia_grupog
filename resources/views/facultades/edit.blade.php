...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form action="{{ route('facultades.update', $facultad->codigo) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-4">
                    ...
                    <input type="text" id="codigo" name="codigo" 
                           ...
                           value="{{ old('codigo', $facultad->codigo) }}"
                           required>
                    @error('codigo')
                ...
                <div class="mb-4">
                    ...
                    <select id="institucion_codigo" name="institucion_codigo" 
                        ...
                        <option value="{{ $institucion->codigo }}" {{ $facultad->institucion_codigo == $institucion->codigo ? 'selected' : '' }}>
                            {{ $institucion->nombre }}
                        </option>
                        @endforeach
                    </select>
