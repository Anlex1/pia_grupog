        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $programa->codigo }}</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('programas.show', $programa->codigo) }}" 
                            ...
                            <form action="{{ route('programas.destroy', $programa->codigo) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" 
